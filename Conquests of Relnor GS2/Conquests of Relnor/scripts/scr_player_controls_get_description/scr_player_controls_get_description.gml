...
switch(argument0){
	...
	case TRIGGER_DESELECT_ALL: return "Deselect All";
	case TRIGGER_DISABLE: return "Disable";
	case TRIGGER_DOWN: return "Down";
	case TRIGGER_ENGAGE: return "Enable Engage";
	case TRIGGER_FORMATION: return "Square Formation";
