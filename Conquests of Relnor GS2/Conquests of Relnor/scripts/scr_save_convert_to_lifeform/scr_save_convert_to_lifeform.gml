...
_lifeform.spawnYear = _lifeform.spawnYear;
_lifeform.spawnMonth = _lifeform.spawnMonth;
_lifeform.spawnDay = _lifeform.spawnDay;
...
_lifeform.engageDistance = _lifeformSave.engageDistance;
...
_lifeform.isWandering = _lifeformSave.isWandering;
