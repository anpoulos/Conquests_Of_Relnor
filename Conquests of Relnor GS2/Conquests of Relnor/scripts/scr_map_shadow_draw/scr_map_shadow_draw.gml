...
var _x = x - _a*dcos(_direction) + sprite_get_xoffset(sprite_index)*dsin(_direction)
				- sprite_get_xoffset(sprite_index)*dcos(_direction);
var _y = y + _a*dsin(_direction) - sprite_height/2*dcos(_direction) + 
...
if(global.debug > 0){
	...
	draw_line_color(x,y, _x, _y, c_white, c_white);
}
