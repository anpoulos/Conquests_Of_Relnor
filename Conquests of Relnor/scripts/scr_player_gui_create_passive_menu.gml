...
var _passiveMenuColorArray = scr_create_obj_array4_repeat(_passiveMenuColor, "_passiveMenuColorArray");
var _passiveMenuPosArray = scr_create_obj_array4(-80,-100,80,100, "_passiveMenuPosArray");
...
scr_destroy_instance(_passiveMenuColorArray);
scr_destroy_instance(_passiveMenuPosArray);
//end of passive menu

//Talk Button
    var _talkButtonColor = make_colour_rgb(50,50,150);
    var _talkButtonPressedColor = make_colour_rgb(0,0,100);
    var _talkButtonColorArray = scr_create_obj_array4_repeat(_talkButtonColor, "_talkButtonColorArray");
    
    var _talkButtonPositionArray = scr_create_obj_array4(-70,-20,70,20, "_talkButtonPositionArray");
    ...
    scr_destroy_instance(_talkButtonColorArray);
    scr_destroy_instance(_talkButtonPositionArray);
    scr_destroy_instance(_talkButtonInfo);
//End of Talk Button
