...
var _menuContainer = scr_ui_menu_create_container(_centerX, _centerY, _menuPosArray, _menuColorArray, true, 1.0);
...
var _buttonInfo = scr_ui_get_obj_ui_button_information(10, scr_ui_menu_title_start_game, "Start", fnt_default_medium, 
_fontColor, 1, 1);
